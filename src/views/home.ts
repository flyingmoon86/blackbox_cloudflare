...
export function theatreHome(
  ...
  const about =
    ...
    '</p></article></div><footer class="stage-contact" id="contact"><span>联系剧团</span><a href="mailto:' +
  ...
  return layout(
    ...
    dialog +
      ...
      about +
      '<nav class="scene-nav" aria-label="首页场景"><a href="#welcome" aria-label="第一幕：首页">01</a><span></span><a href="#about" aria-label="第二幕：剧团">02</a></nav></div>',
    Boolean(user),
    admin,
  );
}
