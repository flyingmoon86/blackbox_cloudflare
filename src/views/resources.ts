...
export function resourcePermissionPage(): string {
  return layout(
    "提交资料",
    '<section class="card auth"><p class="eyebrow">ARCHIVE CONTRIBUTION</p><h1>提交资料需要队员认证</h1><p>完成队员认证后，你可以上传剧本、剧照、视频和音频；管理员审核通过后才会进入资料库。</p><p><a class="button" href="/profile/member-application">申请队员认证</a></p><p><a href="/resources">先浏览资料库</a></p></section>',
    true,
  );
}
