...
export const MEMBER_GUIDE_DEFAULT =
  "先在个人中心完成队员认证，再从作品档案申请自己的角色或分工、补充对应资料。普通账号上传由管理员审核；认证队员的合规资料自动入库；在“我的提交”可查看进度和驳回原因。";
...
export function helpPage(texts: Record<string, string>, admin: boolean, signedIn = true): string {
