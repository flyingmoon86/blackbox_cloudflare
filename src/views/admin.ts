...
export function adminDashboardPage(
  ...
  return layout(
    ...
    <section class="admin-command-groups" aria-label="管理功能">
      ...
      <article class="admin-command-group"><p class="eyebrow">WEBSITE</p><h2>网站设置</h2><nav><a href="/admin/site"><span aria-hidden="true">⚙</span><span>页面与剧团信息</span></a><a href="/help"><span aria-hidden="true">?</span><span>管理员指南</span></a></nav></article>
    </section>
