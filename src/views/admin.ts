...
export function adminDashboardPage(
  ...
  return layout(
    "管理员",
    `<section class="page-heading"><p class="eyebrow">ADMIN</p><h1>管理员工作台</h1><p><a href="/productions">管理作品与演职员</a> · <a href="/admin/productions/new">创建作品</a> · <a href="/admin/resources">管理资料</a> · <a href="/admin/resources/reviews">审核资料</a> · <a href="/announcements">管理公告</a> · <a href="/admin/site">页面管理</a></p>${notices[message] ? `<p class="notice">${notices[message]}</p>` : ""}</section>
