...
export function adminDashboardPage(
  ...
  return layout(
    ...
    <section class="admin-command-groups" aria-label="管理功能">
      ...
      <article class="admin-command-group"><p class="eyebrow">WEBSITE</p><h2>网站设置</h2><nav><a href="/admin/review-history"><span aria-hidden="true">✓</span><span>审核历史</span></a><a href="/admin/system"><span aria-hidden="true">▤</span><span>存储与服务状态</span></a><a href="/admin/site"><span aria-hidden="true">⚙</span><span>页面编辑</span></a></nav></article>
    </section>
