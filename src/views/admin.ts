...
export function adminDashboardPage(
  ...
  return layout(
    ...
    <details class="dashboard-more"><summary>更多管理</summary><nav aria-label="其他管理入口"><a href="/admin/credit-imports">演职人员导入历史 →</a><a href="/admin/review-history">审核历史 →</a><a href="/admin/system">存储与服务状态 →</a></nav></details>
