...
export function productionDetailPage(
  ...
  return layout(
    ...
    ${join}
    ${admin ? `<p><a href="/admin/productions/${item.id}/credits/import">表格导入演职人员</a></p>` : ""}
...
import { backstageCard, backstageFields } from "./backstage";
