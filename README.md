...
本地功能迁移已经覆盖账号、队员、作品、公告、页面文案、资料审核、R2 分片与断点续传、受控下载、头像、作品封面、首页背景和分级帮助。下一步是旧 MySQL 数据转换和真实 Cloudflare 测试环境验收。邮箱发送按用户选择暂缓；当前没有上线，也没有连接正式 Cloudflare 数据库、域名、邮件或真实文件。
