...
尚未完成注册、邮箱验证与找回密码、队员与作品页面、资源审核、R2 大文件上传和管理员后台。目前没有连接正式 Cloudflare 数据库、域名、邮件或真实用户文件，也没有上线。

详细步骤见 [迁移计划](docs/迁移计划.md)，每阶段的实测结果见 [阶段 0 与阶段 1 验证记录](docs/阶段0验证记录.md)。
