...
本地功能迁移已经覆盖账号、队员、作品加入审核、公告、页面文案、意见箱、资料审核、批量剧照、按作品组织的资料库、R2 分片与断点续传、受控下载、头像、作品封面、首页背景和分级帮助。旧 MySQL 导出、D1 转换、一次性内存导入验证和 R2 文件迁移工具也已完成。当前按用户决定继续本地验收，云端部署、域名和邮件暂缓。
